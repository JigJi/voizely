...
{{
  ...
  "speaker_suggestions": [{{"speaker": "Speaker 1", "suggested_name": "ชื่อที่เดา", "reason": "เหตุผล"}}]
}}
...
- speaker_suggestions: รวมจากทุกช่วง deduplicate ถ้ามีหลาย suggestion สำหรับ Speaker เดียวกัน เลือกตัวที่มีเหตุผลดีที่สุด
- ตอบ JSON เท่านั้น ห้ามมีข้อความอื่น"""
